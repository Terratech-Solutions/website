...
const Started = () => {
  ...
  return (
    <section className="flex flex-col pt-39 pb-20 px-23.5 max-sm:px-10 max-w-[1440px] mx-auto">
      <p className="text-[44px] max-sm:text-[35px] pb-[30px] tracking-[3px] pt-2.5">
        {title.part1} <span className="text-true-red">{title.highlight}</span>
      </p>

      <div className="flex justify-between max-lg:flex-col">
        <div className="flex flex-col justify-between tracking-[1px] text-[20px] w-[420px] pt-[20px] pb-[40px] max-lg:w-full max-xl:w-[300px] max-xl:text-[16px]">
